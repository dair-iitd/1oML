...
class MyGPTEncoderSudokuSolver(nn.Module):
    def __init__(self, args):
        super(MyGPTEncoderSudokuSolver, self).__init__()
        ...
        mconf = GPTConfig(vocab_size=10, block_size=81, n_layer=1, n_head=4, n_embd=128, 
                         num_classes=10, causal_mask=False, losses=[], n_recur=32, all_layers=True,
                                 hyper=[1, 0.1])
       
        mconf.sudoku_attention_mask = args.sudoku_attention_mask 
        self.model_config = mconf 
