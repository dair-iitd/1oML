...
class CustomReduceLROnPlateau(lr_scheduler.ReduceLROnPlateau):
    ...
    def shouldStopTraining(self):
        ...
        logger.info("Num_bad_epochs: {0}, unconstrainedBadEpochs: {1}, bestMetric: {2}, currentThreshold: {3}".format(self.num_bad_epochs, self.unconstrainedBadEpochs, self.best,self.currentThreshold))
